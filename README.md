...
- 20% del voto dipenderà dal repository di github dove dovrete caricare gli esercizi proposti durante il corso. Il link del repository va inserito entro il giorno dell'esame in questa pagina [qui](https://units.sharepoint.com/:x:/r/sites/PATC_CD2024_SM32_286SM_457053/Documenti%20condivisi/Laboratorio%20(Nenzi)/Link%20github.xlsx?d=w9bd3789afb2440cda4050f4d04c573ee&csf=1&web=1&e=zcdf6G) . C'è un foglio per ogni anno quindi per l'anno 2025/2026 inserite nell'apposito foglio 2025-2026
...
- La connessione internet non sarà presente ma potrete accedere alla pagina del corso su Moodle,  [link](https://moodle2.units.it/course/view.php?id=15363) ed alla documentazione online delle varie librerie viste a lezione (le pagine ufficiali di ogni libreria, [[link](https://numpy.org)](https://numpy.org), [https://pandas.pydata.org](https://pandas.pydata.org), [https://matplotlib.org](https://matplotlib.org), [https://seaborn.pydata.org](https://seaborn.pydata.org), [https://docs.scipy.org/doc/scipy/](
https://docs.scipy.org/doc/scipy/), [https://plotly.com](https://plotly.com). Il giorno dell'esame troverete sulla pagine del corso su Moodle il testo dell'esame e dovrete caricare sulla stessa piattaforma l'elaborato finale. È essenziale quindi che chiunque voglia fare l'esame sia iscritto al corso del laboratorio su Moodle. 
